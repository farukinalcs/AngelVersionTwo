...
@Component({
  selector: 'app-yemek-menu-tumu',
  templateUrl: './yemek-menu-tumu.component.html',
  styleUrls: ['./yemek-menu-tumu.component.scss']
})
export class YemekMenuTumuComponent implements OnInit, OnDestroy {
