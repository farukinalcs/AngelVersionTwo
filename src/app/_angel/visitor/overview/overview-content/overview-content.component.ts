...
import { TotalVisitorChartComponent } from './total-visitor-chart/total-visitor-chart.component';
import { VisitorCompanyChartComponent } from './visitor-company-chart/visitor-company-chart.component';
import { ProfileService } from 'src/app/_angel/profile/profile.service';
import { CardMenuComponent } from 'src/app/_angel/shared/dashboard-card/card-menu/card-menu.component';
import { VisitorByStaffChartComponent } from './visitor-by-staff-chart/visitor-by-staff-chart.component';
...
@Component({
  ...
  imports: [
    CommonModule,
    FormsModule,
    TotalVisitorChartComponent,
    VisitorCompanyChartComponent,
    CardMenuComponent,
    VisitorByStaffChartComponent
  ],
...
export class OverviewContentComponent implements OnInit, OnDestroy, OnChanges {
  ...
  charts = [
    {
      Id: 1,
      Ad: 'Gelen Ziyaretçi Grafiği',
      component: 'totalVisitorChart',
      collapsed: false,
      visible: false
    },
    {
      Id: 2,
      Ad: 'Ziyaretçi Firma Grafiği',
      component: 'visitorCompanyChart',
      collapsed: false,
      visible: false
    },
    {
      Id: 3,
      Ad: 'Ziyaretçinin Personele Göre Dağılım Grafiği',
      component: 'visitorByStaffChart',
      collapsed: false,
      visible: false
    }
  ];
  ...
  componentMap: { [key: string]: any } = {
    totalVisitorChart: TotalVisitorChartComponent,
    visitorCompanyChart: VisitorCompanyChartComponent,
    visitorByStaffChart: VisitorByStaffChartComponent
  };
  ...
  setMenuVisible(value: any) {
    var sp: any[] = [
      {
        mkodu: 'yek104',
        ad: 'visitor_dashboard_content_visible',
        deger: value,
      }
    ];
